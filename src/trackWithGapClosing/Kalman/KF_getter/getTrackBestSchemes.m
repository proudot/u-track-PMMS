function [trackBestSchemes] = getTrackBestSchemes (kalmanInfoLink,tracksFinal,trackIdx)
...
for t = startTime:endTime
    ...
    if featureIdx ~=0
        trackBestSchemes(tIdx)= ...
            kalmanInfoLink(t).scheme(tracksFinal(trackIdx).tracksFeatIndxCG(tIdx),2);
    else
