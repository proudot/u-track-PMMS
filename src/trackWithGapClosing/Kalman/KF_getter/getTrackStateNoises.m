function [trackStateNoises] = getTrackStateNoises (kalmanInfoLink,tracksFinal,trackIdx)
...
for t = startTime:endTime
    ...
    if featureIdx ~=0
    trackStateNoises(tIdx,:)= ...
        kalmanInfoLink(t).stateNoise(tracksFinal(trackIdx).tracksFeatIndxCG(tIdx),:);
    else
